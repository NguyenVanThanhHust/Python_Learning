# this is to creat list of room in game map
...
DEMO_OBJECT = [images.floor, images.pillar, images.soil]
...
for plantsectors in range(1, 26):
...
def generate_map():
    ...
    # Add middle lines of room_map (wall, floor to fill width, wall)
...
def draw():
    ...
    for y in range(room_height):
        for x in range(room_width):
            image_to_draw = DEMO_OBJECT[room_map[y][x]]
