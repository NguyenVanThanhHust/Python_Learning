...
def test_google():
    ...
    google_crawler.crawl('container', filters=search_filters, max_num=10)
...
def test_bing():
    ...
    search_filters = dict(
        ...
        size='large',
        date='pastmonth')
    bing_crawler.crawl('container', max_num=10, filters=search_filters)
...
def test_baidu():
    ...
    baidu_crawler.crawl('container', filters=search_filters, max_num=10)
